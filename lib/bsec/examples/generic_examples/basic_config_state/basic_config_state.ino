 ...
 * For four class classification please use configuration under
 * config/FieldAir_HandSanitizer_Onion_Cinnamon
 */
...
void setup(void)
{
	...
	Serial.println("\nBSEC library version " + String(envSensor.version.major) + "." +
